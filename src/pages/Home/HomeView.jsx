...
function HomeView() {
  return (
    <PageWrapper>
      ...
      <div className="px-20 md:px-10 lg:px-10 xl:px-10 2xl:px-10 font-medium pt-8 flex flex-row gap-x-2">
      ...
      <div className="px-20 md:px-10 lg:px-10 xl:px-10 2xl:px-10 font-medium pt-4 flex flex-row gap-x-2">
