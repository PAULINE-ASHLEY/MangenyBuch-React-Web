    ...
    <>
      <div className="flex flex-col md:flex-row lg:flex-row xl:flex-row 2xl:flex-row justify-center items-center">
        <div className="lg:w-[60%] xl:w-[60%] 2xl:w-[60%]">
          <div className="grid grid-cols-2 md:flex md:flex-row lg:flex-row xl:flex-row 2xl:flex-row gap-x-4 justify-center items-center px-4 text-sm font-medium gap-y-4">
